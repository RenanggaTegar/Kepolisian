...
<head>
	...
	<link rel="icon" href="dist/img/logo polri-01.png">
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/logo polri-01.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> Database Kepolisian </span>
			</a>
